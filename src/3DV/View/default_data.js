...
export const playerData = {
    ...
    turningSpeed: 110.0, // Expressed in degrees / second
...
export const cameraData = {
    ...
    initialOrientation: new Orientation(180.0, -55.0), // Horizontal and vertical orientation and associated limits (expressed in degrees)
